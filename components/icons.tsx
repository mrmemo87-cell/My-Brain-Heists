...
export const LeaderboardIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"></path><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"></path><path d="M4 22h16"></path><path d="M10 14.66V17h4v-2.34"></path><path d="M8 17h8"></path><path d="M12 12v2.34"></path><path d="M10.5 5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"></path><path d="M16.5 5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"></path><path d="M12 4v4.5"></path></svg>
);

export const CoinIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="12" cy="12" r="8"></circle><line x1="3" y1="6" x2="21" y2="18"></line></svg>
);

export const XPIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m16 13 5.223 3.482a.5.5 0 0 1 0 .836L16 20.8_V13Z"></path><path d="m8 13 5.223 3.482a.5.5 0 0 0 0 .836L8 20.8V13Z"></path><path d="m12 2 5.223 3.482a.5.5 0 0 1 0 .836L12 9.8V2Z"></path><path d="m12 2-5.223 3.482a.5.5 0 0 0 0 .836L12 9.8V2Z"></path></svg>
);

export const StaminaIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z"></path></svg>
);

export const HackingIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m15.5 8.5-2 2-2-2"></path><path d="m12 11.5 2 2 2-2"></path><path d="M2 12h3"></path><path d="M19 12h3"></path><path d="M10.1 4.1 12 6l1.9-1.9"></path><path d="M10.1 19.9 12 18l1.9 1.9"></path><path d="M4.1 10.1 6 12l-1.9 1.9"></path><path d="M19.9 10.1 18 12l1.9 1.9"></path><circle cx="12" cy="12" r="10"></circle></svg>
);
