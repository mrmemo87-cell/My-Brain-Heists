...
import { HackingIcon, SecurityIcon, CoinIcon, StaminaIcon, XPIcon } from '../components/icons';
    ...
    return (
        <div className="animate-fadeIn">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                {/* Gauges */}
                <div className="glassmorphism p-6 rounded-lg border border-cyan-500/20 flex flex-col items-center justify-center">
                    <h3 className="text-xl font-orbitron text-white mb-4">Core Stats</h3>
                    <div className="flex justify-around w-full">
                        <RadialGauge progress={user.hackingSkill} label="Hacking" value={user.hackingSkill} colorClass="text-red-500" />
                        <RadialGauge progress={user.securitySkill} label="Security" value={user.securitySkill} colorClass="text-blue-500" />
                    </div>
                </div>

                {/* Main Stats */}
                <div className="glassmorphism p-6 rounded-lg border border-cyan-500/20 lg:col-span-2">
